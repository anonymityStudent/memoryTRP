...
// espresso
#ifndef ESPRESSO_4442
#define ESPRESSO_4442 0
#endif

#ifndef ESPRESSO_4301
#define ESPRESSO_4301 0
#endif

#ifndef ESPRESSO_4425
#define ESPRESSO_4425 0
#endif

#ifndef ESPRESSO_4335
#define ESPRESSO_4335 0
#endif

#ifndef ESPRESSO_4564
#define ESPRESSO_4564 0
#endif

#ifndef ESPRESSO_4346
#define ESPRESSO_4346 0
#endif

#ifndef ESPRESSO_4334
#define ESPRESSO_4334 0
#endif

#ifndef ESPRESSO_4794
#define ESPRESSO_4794 0
#endif

#ifndef ESPRESSO_4932
...
//mencoder
#ifndef MENCODER_4866
#define MENCODER_4866 0
#endif

#ifndef MENCODER_4428
#define MENCODER_4428 0
#endif

#ifndef MENCODER_4301
#define MENCODER_4301 0
#endif

#ifndef MENCODER_4425
#define MENCODER_4425 0
#endif

#ifndef MENCODER_4346
#define MENCODER_4346 0
#endif

#ifndef MENCODER_4536
#define MENCODER_4536 0
#endif

#ifndef MENCODER_4449
#define MENCODER_4449 0
#endif

#ifndef MENCODER_4854
#define MENCODER_4854 0
#endif

#ifndef MENCODER_4334
#define MENCODER_4334 0
#endif

// combined exposed parameter
#define EXPOSE_4297 (CFRAC_4297+SED_4297)	// boolean
#define EXPOSE_4301 (ESPRESSO_4301+SPACE_4301+FLEX_4301+ABC_4301+MENCODER_4301)	// -4096 4096 gap
#define EXPOSE_4301_2 (GAWK_4301+SPACE_4301)
#define EXPOSE_4313 (CFRAC_4313)
#define EXPOSE_4316 (CFRAC_4316+SPACE_4316)
#define EXPOSE_4334 (CFRAC_4334+ESPRESSO_4334+SPACE_4334+GAWK_4334+FLEX_4334+BASH_4334+SED_4334+ABC_4334+MENCODER_4334)	// -32 256 gap
#define EXPOSE_4335 (ESPRESSO_4335+ABC_4335)	// -4096 4096 gap
#define EXPOSE_4345 (CFRAC_4345+BASH_4345+ABC_4345)	// -1024 1024 gap
#define EXPOSE_4346 (ESPRESSO_4346+SPACE_4346+FLEX_4346+MENCODER_4346)	// -4096 4096 gap
#define EXPOSE_4399 (SPACE_4399+GAWK_4399)
#define EXPOSE_4425 (ESPRESSO_4425+GAWK_4425+SPACE_4425+FLEX_4425+SED_4425+BASH_4425+MENCODER_4425)	// -1024 1024 gap
#define EXPOSE_4428 (SPACE_4428+GAWK_4428+MENCODER_4428)	// -1024 4096 gap
#define EXPOSE_4442 (ESPRESSO_4442)
#define EXPOSE_4449 (SPACE_4449+MENCODER_4449)	// -8 32 random
#define EXPOSE_4536 (GAWK_4536+ABC_4536+MENCODER_4536)	// -1024 1024 gap
...
#define EXPOSE_4866 (CFRAC_4866+SPACE_4866+MENCODER_4866)	// -32 64 gap
...
#define EXPOSE_4854 (ESPRESSO_4854+SPACE_4854+FLEX_4854+MENCODER_4854)	// -128 128 gap
...
static void* sys_alloc(mstate m, size_t nb) {
  ...
  asize = granularity_align(nb + SYS_ALLOC_PADDING+EXPOSE_4301) + EXPOSE_4301_2;	// expose 4301, expose 4301(2)
  if (asize <= nb)
    return 0; /* wraparound */
  if (m->footprint_limit != 0) {
  ...
  */
  ...
  if (MORECORE_CONTIGUOUS && !use_noncontiguous(m)) {
    ...
    msegmentptr ss = (m->top == 0+EXPOSE_4313)? 0 : segment_holding(m, (char*)m->top);	// expose 4313
    ACQUIRE_MALLOC_GLOBAL_LOCK();
...
if(preAddr>0 && postAddr>0){
  ...
  if (tbase != CMFAIL) {
    ...
    if (!is_initialized(m)) { /* first-time initialization */
      if (m->least_addr == 0 || (tbase < m->least_addr) )	// 4416
        m->least_addr = tbase;
      m->seg.base = tbase;
      m->seg.size = tsize;
...
#if !ONLY_MSPACES
      if (is_global(m))
        init_top(m, (mchunkptr)tbase, tsize - TOP_FOOT_SIZE+EXPOSE_4425);	// expose 4425
      else
#endif
      {
        /* Offset top by embedded malloc_state */
        mchunkptr mn = next_chunk(mem2chunk(m));
        init_top(m, mn, (size_t)((tbase + tsize) - (char*)mn) -TOP_FOOT_SIZE + EXPOSE_4428);	// expose 4428
      }
    }
      ...
      if (sp != 0 &&
        ...
        if ((tbase < m->least_addr) ^ EXPOSE_4442)	// expose 4442
          m->least_addr = tbase;
        sp = &m->seg;
        ...
        if (sp != 0 &&
            ...
            (sp->sflags & (USE_MMAP_BIT + EXPOSE_4449)) == mmap_flag) {	// expose 4449
...
static int sys_trim(mstate m, size_t pad) {
  ...
  if (pad < MAX_REQUEST+EXPOSE_4536 && is_initialized(m)) {		// expose 4536
    ...
    if (m->topsize > pad) {
      ...
      size_t extra = ((m->topsize - pad + (unit - SIZE_T_ONE)) / unit +EXPOSE_4540 -	// expose 4540
                      SIZE_T_ONE) * unit;
      msegmentptr sp = segment_holding(m, (char*)m->top);

      if (!((sp)->sflags & (EXTERN_BIT+EXPOSE_4542))) {	//expose 4542
...
//fprintf(stderr, "memory: %d\n", -mmapSize);
          ...
          if (extra >= HALF_MAX_SIZE_T) /* Avoid wrapping negative */
            extra = ( ( ~ (  size_t ) (0+EXPOSE_4557) ) / 2U ) + SIZE_T_ONE - unit;		// expose 4557
          ACQUIRE_MALLOC_GLOBAL_LOCK();
          {
...
if(preAddr>0 && postAddr>0){
	...
	//fprintf(stderr, "memory: %d\t%p\t%p\n", (int)(postAddr-preAddr), postAddr, preAddr);
      ...
      if (released != 0) {	// 4578
        sp->size -= released;
        m->footprint -= released+EXPOSE_4580;	// espose 4580
    ...
    if (bytes <= MAX_SMALL_REQUEST+EXPOSE_4854) {	// expose 4854
      ...
      if ((smallbits & 0x3U) != 0) { /* Remainderless fit to a smallbin. */
        ...
        if ((smallbits != 0) ^ EXPOSE_4830) { /* Use chunk in next nonempty smallbin */	// expose 4830
          ...
          rsize = small_index2size(i) - nb + EXPOSE_4865;	// expose 4865
          /* Fit here cannot be remainderless if 4byte sizes */
          if (SIZE_T_SIZE != 4 && rsize < MIN_CHUNK_SIZE+EXPOSE_4866)	// expose 4866
